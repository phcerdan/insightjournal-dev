...
if not Path(args.cermine_path).expanduser().exists():
    print("CERMINE jar file does not exists {}".format(args.cermine_path))
...
command_base = "java -cp " + args.cermine_path + " " + java_class + " -outputs " + output_types + " -path "
